...
import com.app.noteapp.presentation.common.components.showDateTimePicker
import com.app.noteapp.presentation.common.permission.openAppSettingsInDevice
...
import com.app.noteapp.presentation.screens.notedetail.mapper.NoteDetailEffectMapper
import com.app.noteapp.presentation.screens.notedetail.ui.NDExpandableIconStack
import com.app.noteapp.presentation.screens.notedetail.ui.NDMediaBlockItem
import com.app.noteapp.presentation.screens.notedetail.ui.NDTextBlockItem
import com.app.noteapp.presentation.screens.notedetail.ui.NDTopBar
import com.app.noteapp.presentation.screens.notedetail.ui.rememberPermissionRequester
...
fun NoteDetailScreen(
    ...
    val requestPermission = rememberPermissionRequester(onGranted = {
...
//            viewModel.onImagePermissionDenied()
    })

    val actions = remember {
        NoteDetailUiActions(onConfirmDelete = {
    ...
    val mapper = remember { NoteDetailEffectMapper(actions) }
    ...
    LaunchedEffect(Unit) {
        lifecycle.repeatOnLifecycle(Lifecycle.State.STARTED) {
            viewModel.events.collect { event ->
                when (val effect = mapper.map(event)) {

                    is NoteDetailEffect.Toast -> {
                       ToastUI(effect.message, effect.type)
                    }

                    is NoteDetailEffect.Dialog -> {
                        activeDialog = effect.spec
                    }
...
//            }
            ...
            Box(
                ...
                Column(verticalArrangement = Arrangement.Top, modifier = Modifier.fillMaxSize()) {
                    Text(
                        stringResource(R.string.created_at).plus(" ")
                            .plus(stringResource(R.string.colon)).plus(
