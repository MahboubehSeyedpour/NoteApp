...
//    selected: Language, onSelect: (Language) -> Unit
//) {
//    Column(
//        modifier = Modifier
//            .fillMaxWidth()
...
//                checked = selected == Language.FA,
//                onChecked = { onSelect(Language.FA) },
//                modifier = Modifier.weight(1f)
//            )
//            LanguageRadio(
//                label = stringResource(R.string.lang_en),
//                checked = selected == Language.EN,
//                onChecked = { onSelect(Language.EN) },
//                modifier = Modifier.weight(1f)
//            )
//        }
//    }
